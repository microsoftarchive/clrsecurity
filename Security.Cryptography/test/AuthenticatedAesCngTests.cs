...
namespace Security.Cryptography.Test
{
    ...
    public class AuthenticatedAesCngTests
    {
        ...
        /// <summary>
        ///     Test to ensure that updating the cipher mode does not reset the authentication tag if it is
        ///     still valid for the mode.
        /// </summary>
        [TestMethod]
        ...
        /// <summary>
        ///     Test to ensure that the IV generated by default is valid for use in both CCM and GCM modes
        /// </summary>
        [TestMethod]
